...
export const Demo = () => {
  return (
    <div>
      <div>
      <Button action="#">Hello World!</Button>
      </div>
      <div>
        <Button importance="secondary" action="#">Hello World!</Button>
      </div>

      <div>
        <Button importance="secondary" action="#" full>Hello World!</Button>
      </div>

      <div>
        <Button importance="primary" action="#">Hello World!</Button>
      </div>
      ...
      <div>
        <Button importance="secondary" action="#" inverse >Hello World!</Button>
      </div>

      <div>
        <Button importance="secondary" action="#" full inverse >Hello World!</Button>
      </div>
